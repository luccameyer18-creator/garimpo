...
body > *:not(#pista):not(#porta):not(#luzes):not(dialog):not(.aba-bib):not(#viagem-fundo):not(#viagem-frente):not(#so-viagem):not(#cena-tela):not(.cena-drop) { position:relative; z-index:1; }
