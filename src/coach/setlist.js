...
const FAMILIAS = [
  ...
  ['latino', /reggaeton|perreo|dembow|guaracha|moombah|cumbia|salsa|bachata|amapiano|latin|dancehall|reggae/],
  ...
  ['bass', /dubstep|drum|bass|future|electro\b|jungle|break/],
